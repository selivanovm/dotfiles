" Vim color file
" " Converted from Textmate theme Monokai Dark using Coloration v0.2.4
...
if exists("syntax_on")
  ...
  hi rubyInstanceVariable  guifg=#00ff00 guibg=#0d0d0d gui=bold
  ...
  hi rubyPseudoVariable  guifg=#00ff00 guibg=#0d0d0d gui=bold
