...
" Last Change:	Feb 15, 2013
" Version:	10
" URL:	http://mysite.verizon.net/astronaut/vim/index.html#vimlinks_syntax
" Changes:
"   - Improve Bison and C++ support by Thomas Pelletier
"
" Options: {{{1
...
syn	match	yaccInitKey	"^\s*%\(token\|type\|left\|right\|start\|ident\|nonassoc\|printer\|destructor\)\>"	contained
